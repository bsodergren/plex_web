...
class Template
{
    ...
    public static function GetHTML($template = '', $array = [], $js = '')
    {
        $template_obj = new self();
    ...
    public static function GetJS($template, $replacement_array = '')
    {
        return template::GetHTML($template, $replacement_array, 'javascript');
    } // end Template::GetHTML()
