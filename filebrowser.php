...
?>
<div id="top">
	<a href="home.php<?php //print $this->makeLink(false, false, null, null, null, ""); ?>"><span><?php if(EncodeExplorer::getConfig('main_title') != null) print EncodeExplorer::getConfig('main_title'); ?></span></a>
<?php
...
if($this->files)
{
	...
	foreach ($this->files as $file)
	{
		...
		print "\t\t<a href=\"view.php?file=".$file->getNameEncoded()."&dir=".$_REQUEST['dir']."\"";
